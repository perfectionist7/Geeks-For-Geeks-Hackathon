                      ...
                      Column(
                        children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(38, 3, 96, 0),
                            child: TextField(
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(30, 39, 198, 0),
                            child: Text(
                              'Full Name',
                              style: TextStyle(
                                  fontSize: 20,
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(0, 21, 198, 0),
                            child: Text(
                              'E-mail',
                              style: TextStyle(
                                  fontSize: 20,
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(30, 30, 198, 0),
                            child: Text(
                              'Password',
                              style: TextStyle(
                                  fontSize: 20,
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(90, 185, 90, 20),
                            child: TextButton(
                              onPressed: () {
                                Navigator.push(
                                  context,
